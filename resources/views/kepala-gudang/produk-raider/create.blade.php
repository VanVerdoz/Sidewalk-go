...
<div class="content">
    <div class="d-flex align-items-center mb-4" style="display:flex; align-items:center; gap:15px; margin-bottom:1.5rem;">
        ...
        <h2 style="margin:0; font-size:1.5rem; font-weight:600;">Kirim Stok ke {{ $cabang->nama_cabang }}</h2>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('kepala.produk-raider.store', $cabang->id) }}" method="POST">
                @csrf
