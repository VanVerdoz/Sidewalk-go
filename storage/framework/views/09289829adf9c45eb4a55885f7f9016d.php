<?php $__env->startSection('title', 'Edit Laporan Keuangan'); ?>
...
<div class="form-container">
    <form action="<?php echo e(route('laporan-keuangan.update', $laporan->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                ...
                <option value="<?php echo e($item->id); ?>" <?php echo e(old('cabang_id', $laporan->cabang_id) == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                   value="<?php echo e(old('periode_awal', $laporan->periode_awal)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                   value="<?php echo e(old('periode_akhir', $laporan->periode_akhir)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                   value="<?php echo e(old('total_pendapatan', $laporan->total_pendapatan)); ?>" step="0.01" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\RplBo\UasFix\BE-API-SW\resources\views\laporan-keuangan\edit.blade.php ENDPATH**/ ?>