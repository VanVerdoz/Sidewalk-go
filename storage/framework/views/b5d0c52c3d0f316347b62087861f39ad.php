...
<head>
    ...
    <style>
        * {
        ...
        .dark .header-title-pill { background: var(--surface); }
        .theme-group {
            display: flex;
            align-items: center;
            gap: 8px;
        ...
        .aside-yellow {
            background: linear-gradient(135deg, #f7b500 0%, #ffd36b 100%);
            color: #3a2c00;
            border: none;
        }
        .aside-yellow .icon { background: rgba(0,0,0,0.22); }
        .aside-pink {
                ...
                <div class="header-left">
                    ...
                    <div class="header-topbar">
                        <div class="header-title-pill">
                            <i class="fas fa-chart-line"></i>
                            <span>Dashboard <?php echo e(ucfirst(str_replace('_', ' ', $role))); ?></span>
                        </div>
                    ...
                    <div class="header-hero-row">
                        ...
                        <div class="hero-left">
                            <div class="hero-title">Hi <?php echo e($user['nama_lengkap'] ?? $user['username'] ?? 'Pengguna'); ?>, Selamat Datang Kembali!</div>
                            ...
                            <div class="hero-meta">
                                <span><?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></span>
                                <span>Peran: <?php echo e(ucfirst(str_replace('_', ' ', $role))); ?></span>
                            </div>
                        </div>
                        <div class="hero-illustration">
                            <svg viewBox="0 0 360 140" class="hero-svg" xmlns="http://www.w3.org/2000/svg" fill="none">
                                <g class="float">
                                    <rect x="210" y="74" width="90" height="44" rx="8" fill="#2b2d42"/>
                                    <rect x="216" y="80" width="78" height="30" rx="4" fill="#3a3d5a"/>
                                    <rect x="210" y="118" width="90" height="6" rx="3" fill="#1f2133"/>
                                    <circle cx="160" cy="78" r="20" fill="#ffd166"/>
                                    <rect x="140" y="96" width="40" height="24" rx="8" fill="#ef476f"/>
                                    <rect x="146" y="100" width="28" height="12" rx="4" fill="#ff6b6b"/>
                                    <rect x="130" y="120" width="60" height="6" rx="3" fill="#c23d5a"/>
                                    <rect x="120" y="68" width="20" height="10" rx="3" fill="#ffd166"/>
                                    <rect x="180" y="68" width="20" height="10" rx="3" fill="#ffd166"/>
                                    <rect x="120" y="76" width="80" height="10" rx="5" fill="#ffd166"/>
                                    <circle cx="160" cy="58" r="10" fill="#ffd166"/>
                                    <rect x="270" y="92" width="8" height="18" rx="2" fill="#e0e0e0"/>
                                    <rect x="268" y="110" width="12" height="6" rx="3" fill="#cfcfcf"/>
                                    <path class="steam" d="M 272 88 C 270 84, 270 80, 272 76" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/>
                                    <path class="steam" d="M 278 88 C 276 84, 276 80, 278 76" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/>
                                </g>
                            </svg>
                        </div>
                        </div>
                            ...
                            <div class="aside-card aside-yellow">
                                <div>
                                    <?php if(($role ?? '') === 'kepala_gudang'): ?>
                                        ...
                                        <div class="value"><?php echo e(\App\Models\RequestStok::count()); ?></div>
                                    <?php elseif(($role ?? '') === 'raider'): ?>
                                        <div class="label">Total Request Stok Pending</div>
                                        <div class="value"><?php echo e(\App\Models\RequestStok::where('status_permintaan','pending')->where('id_raider', session('user.id'))->count()); ?></div>
                                    <?php elseif(($role ?? '') === 'admin'): ?>
                                        <div class="label">Total Laporan Keuangan</div>
                                        <div class="value"><?php echo e(\App\Models\LaporanKeuangan::count()); ?></div>
                                    <?php else: ?>
                                        <div class="label">Total Pengguna</div>
                                        <div class="value"><?php echo e(\App\Models\Pengguna::count()); ?></div>
                                    <?php endif; ?>
                                </div>
                                <div class="icon">
                                    <?php if(($role ?? '') === 'kepala_gudang'): ?>
                            ...
                            <div class="aside-card aside-pink">
                                <div>
                                    <div class="label">Total Request Disetujui</div>
                                    <div class="value"><?php echo e(\App\Models\RequestStok::where('status_permintaan','disetujui')->count()); ?></div>
                                </div>
