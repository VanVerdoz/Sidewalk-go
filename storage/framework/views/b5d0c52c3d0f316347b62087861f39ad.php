...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/sw3.png')); ?>" type="image/png">
...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar">
            <div class="sidebar-logo">
                <div class="sidebar-logo-circle">
                   <img src="<?php echo e(asset('images/sw3.png')); ?>" alt="Logo Sidewalk.Go">
                </div>
                <h2>Sidewalk.Go</h2>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?php echo e(route('penjualan.index')); ?>" class="<?php echo e(request()->routeIs('penjualan.*') ? 'active' : ''); ?> <?php echo e((request()->routeIs('dashboard') && ($role ?? '') === 'raider') ? 'glass-white' : ''); ?>">
                ...
                <?php if($role === 'raider'): ?>
                <li>
                    <a href="<?php echo e(route('raider.permintaan-stok.create')); ?>" class="<?php echo e(request()->routeIs('raider.permintaan-stok.*') ? 'active' : ''); ?> <?php echo e((request()->routeIs('dashboard') && ($role ?? '') === 'raider') ? 'glass-white' : ''); ?>">
        ...
        <main class="main-content">
            <!-- Header -->
            <header class="header <?php echo e(request()->routeIs('dashboard') ? 'header-orange' : ''); ?>">
                <div class="header-left">
                    ...
                    <div class="header-hero-row">
                        ...
                        <div class="hero-illustration">
                            <img src="<?php echo e(asset('images/Hero.png')); ?>" alt="Ilustrasi pekerja" class="hero-person-img">
                        </div>
                        </div>
                            ...
                            <div class="aside-card aside-yellow">
                                <div>
                                    ...
                                    <?php elseif(($role ?? '') === 'raider'): ?>
                                        ...
                                        <div class="value"><?php echo e(\App\Models\RequestStok::where('status','pending')->where('raider_id', session('user.id'))->count()); ?></div>
                            ...
                            <div class="aside-card aside-pink">
                                <div>
                                    ...
                                    <div class="value"><?php echo e(\App\Models\RequestStok::where('status','disetujui')->whereDate('tanggal', \Carbon\Carbon::today())->count()); ?></div>
                                </div>
