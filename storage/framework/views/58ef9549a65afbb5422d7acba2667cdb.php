        ...
        <div class="form-group">
            ...
            <select name="produk_id" class="form-control" required>
                ...
                <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($p->id); ?>" <?php echo e(old('produk_id') == $p->id ? 'selected' : ''); ?>><?php echo e($p->nama_produk); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="number" name="jumlah" class="form-control" value="<?php echo e(old('jumlah', 0)); ?>" min="0" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\RplBo\UasFix\BE-API-SW\resources\views\stok\create.blade.php ENDPATH**/ ?>